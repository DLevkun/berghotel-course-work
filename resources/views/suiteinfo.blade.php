		...
		<div class="flex-wrap">
			<div class="slider-wrap">
				<div id="first-slide" class="slide active">
					<!-- <img src="{{ asset('/publicimg/image1.jpg')}}" alt="image1" height="500"> -->
				</div>
				<div id="second-slide" class="slide">
					<!-- <img src="{{ asset('/publicimg/image2.jpg')}}" alt="image2" height="500"> -->
				</div>
				<div id="third-slide" class="slide">
					<!-- <img src="{{ asset('/publicimg/image3.jpg')}}" alt="image3" height="500"> -->
				</div>
				<div id="fourth-slide" class="slide">
					<!-- <img src="{{ asset('/publicimg/image4.jpg')}}" alt="image4" height="500"> -->
				</div>
				<div id="fifth-slide" class="slide">
					<!-- <img src="{{ asset('/publicimg/image5.jpg')}}" alt="image5" height="500"> -->
				</div>
				<div id="btn-prev">
